<x-auth-layout>
    ...
    <section class="gradient-form h-full bg-neutral-200 dark:bg-neutral-300">
        <div class="container h-full p-10">
            <div
            class="flex h-full flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200">
            <div class="w-full">
                <div
                class="block rounded-lg bg-white shadow-lg dark:bg-neutral-100">
                <div class="g-0 lg:flex lg:flex-wrap">
                    ...
                    <div class="md:mx-6 md:p-12">
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            @csrf
                            <p class="mb-4 text-black">Please register to your account</p>
                            <!--Username input-->
                            ...
                            <div class="mb-12 pb-1 pt-1 text-center">
                                ...
                                <a href="#!" class="text-black">Remember me?</a>
                            </div>
